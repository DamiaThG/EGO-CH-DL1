...
ANNOTATIONS_DIR=${2:-"data/Points Of Interest Recognition/Palazzo Bellomo/Training/bbox_annotations"}
LABELS_FILE=${3:-"data/Object Retrieval/Palazzo Bellomo/labels.txt"}
