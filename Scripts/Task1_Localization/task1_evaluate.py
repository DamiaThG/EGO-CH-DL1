...
def evaluate(checkpoint_path, test_dir, dataset='bellomo', save_path=None):
    ...
    lit_model = Task1LightningModule.load_from_checkpoint(checkpoint_path, model=mamba_model, map_location=device)
    lit_model.eval()
...
if __name__ == '__main__':
    ...
    evaluate(args.checkpoint, args.test_dir, args.dataset, save_path=args.save_path)