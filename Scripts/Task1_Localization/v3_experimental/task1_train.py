...
class Task1LightningModule(L.LightningModule):
    def __init__(self, model, num_classes, class_weights=None, lr=1e-3, weight_decay=1e-4, max_epochs=50, label_smoothing=0.0):
        super().__init__()
        self.model = model
        ...
        if class_weights is not None:
            # Assicurati che i pesi siano sullo stesso device del modulo
...
def main():
    ...
    lit_model = Task1LightningModule(
        model=model, num_classes=num_classes, class_weights=class_weights,
